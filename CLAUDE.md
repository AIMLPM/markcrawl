...
1. **Title** — `# Report Name`
2. **One-line summary** — what question does this report answer?
3. **Summary table** — all tools, ranked by primary metric. This is the first
   thing a reader should see.
4. **Per-site breakdowns** — detailed results grouped by site.
5. **Methodology** — how to reproduce, what was measured, what was NOT measured.
...
- Note which tools use JS rendering vs plain HTTP.
- Link to METHODOLOGY.md for full test setup.
